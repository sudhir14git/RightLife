...
import com.jetsynthesys.rightlife.databinding.BottomsheetChallengeNotificationBinding
...
object ChallengeBottomSheetHelper {
    ...
    fun showChallengeReminderBottomSheet(
        activity: Activity,
        onEnableClick: (dialog: BottomSheetDialog) -> Unit
    ) {

        val bottomSheetDialog = BottomSheetDialog(activity)
        val binding = BottomsheetChallengeNotificationBinding.inflate(activity.layoutInflater)
        bottomSheetDialog.setContentView(binding.root)
        ...
        binding.btnEnableNotifications.setOnClickListener {
            onEnableClick(bottomSheetDialog)
        }
