...
class GenderSelectionFragment : Fragment() {
    ...
    // Add flag to prevent multiple selections
    ...
    override fun onCreateView(
        ...
        llMale.setOnClickListener {
            ...
            if (isSelectionInProgress) return@setOnClickListener
            isSelectionInProgress = true

            // Disable both views immediately
            llMale.isClickable = false
            llFemale.isClickable = false
    ...
    override fun onPause() {
        ...
        llMale.isClickable = true
        llFemale.isClickable = true
    }
