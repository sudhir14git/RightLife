    ...
    inner class CoilImageGetter : Html.ImageGetter {
        override fun getDrawable(source: String): Drawable? {
            val resourceId = when (source) {
                "heart_icon" -> R.drawable.ic_heartbeat_black
